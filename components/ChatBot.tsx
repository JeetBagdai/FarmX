...
import { createChatSession, translateChatHistory } from '../services/geminiService';
...
const ChatBot: React.FC<ChatBotProps> = ({ forecast, region, crop, language, t }) => {
  ...
  const handleSendMessage = async (e?: React.FormEvent) => {
    ...
    try {
        ...
        const botText = response.text || t("I'm sorry, I couldn't understand that. Please try again.");
