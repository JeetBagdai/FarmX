...
const getDecisionClasses = (decision: string) => {
  if (decision.includes('GROW') || decision.includes('✅')) return 'bg-green-100 text-green-800 border-green-300';
  if (decision.includes('AVOID') || decision.includes('❌')) return 'bg-red-100 text-red-800 border-red-300';
  if (decision.includes('CAUTION') || decision.includes('⚠️')) return 'bg-yellow-100 text-yellow-800 border-yellow-300';
